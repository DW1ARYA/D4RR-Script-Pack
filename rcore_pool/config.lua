Config = {
    ...
    Text = {
        ...
        HINT_SETUP = 'Build a game',
        HINT_TAKE_CUE = 'Take A cue',
        HINT_RETURN_CUE = 'Menyimpan Cue',
        HINT_HINT_TAKE_CUE = 'To play billiards, you need a cue.',
        HINT_PLAY = 'Play',
        ...
        BALL_IN_HAND_NOTIFY = '%s put the ball in the hole',
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',
